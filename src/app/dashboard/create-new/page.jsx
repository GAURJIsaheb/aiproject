...
function CreateNewVideo() {
  ...
  const [videoScriptData,setvideoScriptData]=useState();//jo data user se aa rha,,options,,click krne se uske,,vo yahan save kra rhehain
  ...
  const GetVideoScript=async ()=>{
    setloading(true);
    const Makeprompt='Write a script to generate '+formDataa.duration+' seconds video on topic:'+formDataa.topic+' along with AI image prompt in '+formDataa.imageStyle+' format for each scene and give me result in JSON format with imagePrompt and ContextTest as field'
